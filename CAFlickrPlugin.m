...
#import "CAFlickrPlugin.h"
#import "CAFlickrImageGrabber.h"

@implementation CAFlickrPlugin
...
+ (CARelevance)relevanceForPivot:(CAPivot *)pivot
{
	...
	if ([CAFlickrImageGrabber hasExpectedPrefix:dt.string]) {
...
- (void)copyClip:(CAClip *)clip
{
	...
	CAFlickrImageGrabber *grabber = [[CAFlickrImageGrabber alloc] initWithString:dt.string];
...
+ (BOOL)isFlickrURL:(NSString *)url
{
	return [url hasPrefix:@"http://www.flickr.com/photos/"];
}
